# handlers/user_handlers.py (опционально, если где-то ещё импортируется)
...
__all__ = [
    "start", "show_menu", "handle_sticker", "show_my_tracking", "cancel_my_tracking",
    "reply_keyboard_handler", "menu_button_handler", "dislocation_inline_callback_handler",
    "handle_message",
]